...
The request log retains the newest 1,000 entries so long-running sessions stay memory-bounded. Clearing it releases the retained queue storage immediately.
