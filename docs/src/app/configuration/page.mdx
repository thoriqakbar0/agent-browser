...
<table>
  ...
  <tbody>
    ...
    <tr><td><code>engine</code></td><td><code>--engine</code></td><td>string (<code>camofox</code>, <code>chrome</code>, <code>lightpanda</code>)</td></tr>
...
<table>
  ...
  <tbody>
    ...
    <tr><td><code>AGENT_BROWSER_ENGINE</code></td><td>Browser engine to use: <code>camofox</code> (default), <code>chrome</code>, or <code>lightpanda</code>.</td><td><code>camofox</code></td></tr>
    <tr><td><code>AGENT_BROWSER_CAMOFOX_EXECUTABLE</code></td><td>Path to the Camofox server executable.</td><td><code>camofox-browser</code> beside the agent-browser binary or on PATH</td></tr>
    <tr><td><code>AGENT_BROWSER_CAMOFOX_URL</code></td><td>Attach to an existing Camofox server instead of launching one.</td><td>(none)</td></tr>
    <tr><td><code>AGENT_BROWSER_CAMOFOX_ACCESS_KEY</code></td><td>Access key sent to and configured on the Camofox server.</td><td>(none)</td></tr>
