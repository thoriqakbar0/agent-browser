...
Chrome and Chromium are available through the Chrome DevTools Protocol (CDP). agent-browser discovers, launches, and manages the browser process automatically when you select the Chrome engine.
