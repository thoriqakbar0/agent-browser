...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Create new sessions from the dashboard with local engines (Camofox, Chrome, Lightpanda) or cloud providers (AgentCore, Browserbase, Browserless, Browser Use, Kernel)</td>
    </tr>
    <tr>
