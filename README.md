...
Request tracking retains the newest 1,000 entries so long-running sessions stay memory-bounded. Use `network requests --clear` to release the retained request log immediately.
